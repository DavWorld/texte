...
requirements = python3,Kivy==2.2.1,kivymd==1.1.1,pillow,google-api-core,google-api-python-client,google-auth,google-auth-oauthlib,google-auth-httplib2,googleapis-common-protos,keyboard
...
android.permissions = INTERNET, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE, RECEIVE_BOOT_COMPLETED, WAKE_LOCK, FOREGROUND_SERVICE
